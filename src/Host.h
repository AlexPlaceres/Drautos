...
/**
 * Discerns between two relative virtual addresses based on the host process type.
 ...
 */
#define DISCERN(debugRva, releaseRva) (Host::Type == Host::DEBUG ? debugRva : releaseRva)
 ...
 */
#define REBASE(debugRva, releaseRva) (Host::BaseAddress + (Host::Type == Host::DEBUG ? debugRva : releaseRva))
...
public:
    ...
    static void Initialize()
    {
        ...
        {
            throw cpptrace::runtime_error("Failed to get module information for ffxv_s.exe");
        }
