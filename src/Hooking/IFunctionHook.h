...
namespace Hooks
{
    ...
    public:
        ...
        /**
         * Gets a reference to the pointer that points to the function that will be detoured.
         * @return Reference to the target function pointer.
         */
        virtual void** GetTargetFunctionPointerReference() = 0;

        /**
         * Gets a pointer that points to the function that detours the target function.
