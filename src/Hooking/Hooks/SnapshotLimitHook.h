...
{
/**
 * Increases the maximum number of Prompto snapshots that the game will allow
 * the user to save.\n\n Hooks the following method:
 * @code
 * __int64 __fastcall
 * Black::AI::Buddy::Snapshot::BuddySnapshotStorage::GetSnapshotMaxNum(
