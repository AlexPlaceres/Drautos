...
namespace Hooks
{
     ...
     * @code
     * Black::Menu::FontUtil* __fastcall SQEX::Luminous::Core::Singleton<Black::Menu::FontUtil>::Get()
     * @endcode
     * @remarks This is one of two hooks that adds a patch archive to the asset manager.
     *          This one is hooked later in the game's initialization process, as calling
     *          it earlier was causing visual anomalies once the game was loaded, which
     *          seemed possibly related to shader passes.
     */
    ...
    protected:
         ...
         * @remarks This detour will add patch/patch1/patchindex.earc to the asset manager the first time it is called.
         */
