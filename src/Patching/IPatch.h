...
namespace Patches
{
    ...
    public:
        ...
        /**
         * Gets the expected number of times that the target signature should appear in memory.
         * @return -1 if the number of occurrences may be variable, otherwise the expected number of occurrences.
         ...
         * @return The hexadecimal string representation of the target memory pattern.
         */
        virtual const char* GetTargetSignature() = 0;

        /**
         * Gets the byte pattern that will replace the target signature.
         * @return The hexadecimal string representation of the patch memory pattern.
         */
