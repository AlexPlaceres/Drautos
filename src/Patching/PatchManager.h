...
{
/**
 * Handles applying patches to the game and cleaning up when the application
 * closes.
 */
class PatchManager
{
  ...
  public:
     ...
     */
    template <typename TPatch> void Register()
    {
     ...
     * @remarks Patches will only be applied if their ShouldApply function
     * returns true.
     */
